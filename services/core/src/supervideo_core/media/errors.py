...
MediaErrorCode = Literal[
    ...
    "SCRIPT_STORYBOARD_INPUT_INVALID",
    "SCRIPT_STORYBOARD_SOURCE_INVALID",
    "SCRIPT_STORYBOARD_DURATION_INVALID",
    "SCRIPT_STORYBOARD_ROLE_INVALID",
    "SCRIPT_STORYBOARD_OUTPUT_INVALID",
    "SCRIPT_STORYBOARD_CANCELLED",
    ...
    "FINAL_EXPORT_AUDIO_NOT_READY",
    "FINAL_EXPORT_AUDIO_INVALID",
    "FINAL_EXPORT_AUDIO_TAMPERED",
...
ERRORS: Final[dict[str, MediaErrorDefinition]] = {
    ...
    "SCRIPT_STORYBOARD_INPUT_INVALID": MediaErrorDefinition("The D05 script/storyboard input is invalid or exceeds its bounds."),
    "SCRIPT_STORYBOARD_SOURCE_INVALID": MediaErrorDefinition("The C02/C03 source is invalid for D05 script/storyboard planning."),
    "SCRIPT_STORYBOARD_DURATION_INVALID": MediaErrorDefinition("The D05 script/storyboard duration accounting is invalid."),
    "SCRIPT_STORYBOARD_ROLE_INVALID": MediaErrorDefinition("The D05 script/storyboard role order is invalid."),
    "SCRIPT_STORYBOARD_OUTPUT_INVALID": MediaErrorDefinition("The D05 script/storyboard output was invalid."),
    "SCRIPT_STORYBOARD_CANCELLED": MediaErrorDefinition("The D05 script/storyboard operation was cancelled."),
    ...
    "FINAL_EXPORT_AUDIO_NOT_READY": MediaErrorDefinition("The C04 audio result has not completed successfully and cannot be muxed."),
    "FINAL_EXPORT_AUDIO_INVALID": MediaErrorDefinition("The C04 audio output is not a verified AAC stream of the expected duration."),
    "FINAL_EXPORT_AUDIO_TAMPERED": MediaErrorDefinition("The C04 audio output changed or does not match its recorded fingerprint."),
