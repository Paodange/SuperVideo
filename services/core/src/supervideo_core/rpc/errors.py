...
ERRORS: Final[dict[str, RpcErrorDefinition]] = {
    ...
    "RESEARCH_INPUT_INVALID": RpcErrorDefinition(-32500, "The research input is invalid."),
    "RESEARCH_URL_INVALID": RpcErrorDefinition(-32501, "The research source URL is not allowed."),
    "RESEARCH_SOURCE_INVALID": RpcErrorDefinition(-32502, "The research source record is invalid."),
    "RESEARCH_IDEMPOTENCY_CONFLICT": RpcErrorDefinition(-32503, "The research idempotency key conflicts with another request."),
    "RESEARCH_TRANSPORT_UNAVAILABLE": RpcErrorDefinition(-32504, "The research transport is unavailable."),
    "RESEARCH_TIMEOUT": RpcErrorDefinition(-32505, "The research transport timed out."),
    "RESEARCH_CANCELLED": RpcErrorDefinition(-32506, "The research operation was cancelled."),
    "RESEARCH_STORAGE_INVALID": RpcErrorDefinition(-32507, "The research storage record is invalid."),
    ...
    "REMOTION_INPUT_INVALID": RpcErrorDefinition(-32440, "The Remotion render input is invalid."),
    "REMOTION_SOURCE_INVALID": RpcErrorDefinition(-32441, "The Remotion source reference is invalid."),
    "REMOTION_OUTPUT_INVALID": RpcErrorDefinition(-32442, "The Remotion render output is invalid."),
    "REMOTION_RUNTIME_UNAVAILABLE": RpcErrorDefinition(-32443, "The fixed Remotion runtime is unavailable."),
