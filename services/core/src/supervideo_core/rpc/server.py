...
class RpcServer:
    ...
    async def dispatch(self, request: RpcRequest) -> None:
        ...
        if request.method in {"core.smoke.countdown", "media.probe", "media.proxy", "media.transcribe", "media.vad", "media.sentences", "media.sentences.index", "media.sentences.retrieve", "media.script.align", "plan.create_remix", "media.aroll.cut_join", "media.subtitle.plan"}:
